...
function modelIcon(id) {
    ...
    if (s.includes("gpt") || s.includes("codex"))
        return "◈";
    return "◆";
}
...
export function installCwd(ctx) {
    ctx.ui.setWidget("tw-cwd", (_tui, theme) => ({
        invalidate() { },
        render(width) {
